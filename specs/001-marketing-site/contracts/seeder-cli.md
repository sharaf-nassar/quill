...
The seeder writes deterministic dummy content into a Quill data directory plus optional rules and transcript roots. It supports backend/Tauri demo work; marketing screenshot publishing uses Browser Mock Mode instead.
